...
Similarly, when we compared multiple alternative models via the likelihood ratio test, we did not find any that were a significantly better fit than the null model.  Therfore, this method also indicates that we do not evidence to reject the null hypothesis.
